...
function AnalyticsPage() {
  ...
  */
  ...
  /*
  Join Socket.IO analytics room
  and refresh analytics when a new
  event is stored.
  */
  ...
  useEffect(() => {
    ...
    */
    ...
    socket.on("connect", joinAnalyticsRoom);
    ...
    /*
    Cleanup listener when website changes
    ...
    */
    ...
    return () => {
      ...
      socket.off("connect", joinAnalyticsRoom);
    };
  }, [
    trackingId,
    days,
    ...
    <div className="dashboard-page space-y-8 fade-page">
      ...
      <div className="flex flex-wrap items-end justify-between gap-5">
        ...
        <div>
          ...
          <h1 className="page-heading text-3xl font-bold">
            Analytics
          </h1>

          <p className="page-subtitle mt-2 text-sm">
            Explore the sources, behaviors, and patterns behind your traffic.
          </p>
      ...
      {!trackingId ? (
        ...
        <div className="empty-state p-8 text-sm">
          Please select a website to explore analytics
        </div>
        ...
        <>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div>
              ...
              <p className="panel-heading font-semibold">
                Reporting period
              </p>

              <p className="panel-meta mt-1">
                Compare performance across your selected window.
              </p>
          ...
          {sessionStats && (
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <h2 className="panel-heading font-semibold">
                  Session quality
                </h2>

                <p className="panel-meta mt-1">
                  How visitors move through your properties.
                </p>
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <p className="panel-meta mt-1">
                The pages, events, sources, and regions driving activity.
              </p>
